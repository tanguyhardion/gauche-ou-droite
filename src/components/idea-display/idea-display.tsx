...
export const IdeaDisplay = component$<IdeaDisplayProps>(({ idea, isLoading = false }) => {
  if (isLoading) {
    return (
      <>
      ...
      <>
        ...
        <div class="idea-display">
          <div class="idea-display__empty">
            ...
            <p class="idea-display__empty-subtitle">Toutes les idées ont été vues ou il y a un problème de connexion.</p>
          </div>
        </div>
      </>
    );
    ...
    <>
      ...
      <div class="idea-display">
        <div class="idea-display__content">
          <p class="idea-display__text">
            {idea.text}
          </p>
          {idea.category && (
            <span class="idea-display__category">
              {idea.category}
            </span>
          )}
        </div>
